...
#define STR_FORMAT_TEXT_BUFFER_SIZE     PARNIANMINER_KB(12)
...
{
    va_list argList;
    char szBuffer[PARNIANMINER_KB(4)];
...
{
    va_list argList;
    char szBuffer[PARNIANMINER_KB(12)];
    ...
    {
        printf("%s", str);
#if defined(PARNIANMINER_DEBUG) || defined(RH_OUTPUT_TO_DEBUGGER)
        OutputDebugStringA(str);
#endif
    }
