...
#include "MinersLib/Parnian/RandomHash_core.h"
...
/*
    ...
    Parnianminer could use some AVX instructions (see code in this file) to speed up some operations AND it could use the load/store to speed memory-ound operations (see code in this file).
    ...
    ParnianCoin <https://parniancoin.com>
    Author: Amir Reza Zamani <amirrezazamani@gmail.com>
*/
...
#define _RH_LD_LINE_256(r) r = _mm256_lddqu_si256((__m256i *)(source)); 
    ...
    case 0:
        ...
        break;
    default: PARNIANMINER_ASSERT(false);
    }
