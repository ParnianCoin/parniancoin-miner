...
//force UT
#ifdef _DEBUG
    #define PARNIANMINER_DEBUG_RANDOMHASH_UNITTEST
#endif

#ifndef _DEBUG
    #undef PARNIANMINER_DEBUG_RANDOMHASH_UNITTEST
#endif


#include "MinersLib/Parnian/RandomHash.h"
#include "MinersLib/Parnian/RandomHash_MurMur3_32.h"  

#include "MinersLib/Parnian/RandomHash_Blake2b.h" 
#include "MinersLib/Parnian/RandomHash_Blake2s.h"
#include "MinersLib/Parnian/RandomHash_Grindahl512.h"
#include "MinersLib/Parnian/RandomHash_Haval_5_256.h" 
#include "MinersLib/Parnian/RandomHash_MD5.h"
#include "MinersLib/Parnian/RandomHash_RadioGatun32.h"
#include "MinersLib/Parnian/RandomHash_RIPEMD160.h" 
#include "MinersLib/Parnian/RandomHash_RIPEMD256.h"
#include "MinersLib/Parnian/RandomHash_RIPEMD320.h"
#include "MinersLib/Parnian/RandomHash_SHA2_256.h"
#include "MinersLib/Parnian/RandomHash_SHA2_512.h"
#include "MinersLib/Parnian/RandomHash_SHA3_512.h"
#include "MinersLib/Parnian/RandomHash_Snefru_8_256.h"
#include "MinersLib/Parnian/RandomHash_Tiger2_5_192.h"
#include "MinersLib/Parnian/RandomHash_Whirlpool.h"

//--------------- RandomHash2 -------------------
#include "MinersLib/Parnian/RandomHash_Ghost.h"
#include "MinersLib/Parnian/RandomHash_Ghost3411.h"
#include "MinersLib/Parnian/RandomHash_MD2.h"
#include "MinersLib/Parnian/RandomHash_MD4.h"
#include "MinersLib/Parnian/RandomHash_Panama.h"
#include "MinersLib/Parnian/RandomHash_HAS160.h"
#include "MinersLib/Parnian/RandomHash_SHA.h"
#include "MinersLib/Parnian/RandomHash_Grindahl256.h"
#include "MinersLib/Parnian/RandomHash_Haval.h"
#include "MinersLib/Parnian/RandomHash_RIPEMD.h"
#include "MinersLib/Parnian/RandomHash_RIPEMD128.h"


#define RH_FULLDEBUG_CPU 
#ifdef PARNIANMINER_RELEASE
    #undef RH_FULLDEBUG_CPU
#endif

#include "corelib/CommonData.h"

#include "MinersLib/Parnian/RandomHash_inl.h"
...
inline void RandomHash_Initialize(RandomHash_State* state)
{
...
#ifdef PARNIANMINER_DEBUG_STRIDE_INTEGRITY_CHECK
    ...
    PARNIANMINER_ASSERT(*check == 0xFF55AA44BB8800DDLLU);
#endif
}
...
{
    PARNIANMINER_ASSERT(headerSize == ParnianHeaderSizeV5); //optimized for 236 header
    U8* targetInput = state->m_header;
    state->m_isNewHeader = true;
    state->m_parnianHeaderSize = headerSize;
...
#endif
    memcpy(targetInput, sourceHeader, state->m_parnianHeaderSize);
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    inline void RH_StrideArrayClose(RandomHash_State* state, RH_StridePtr stride)
    {
        ...
        ss += sizeof(U64);
#endif
        RH_ASSERT(PARNIANMINER_ALIGN(state->m_stridesAllocIndex + ss, 32) > state->m_stridesAllocIndex);
        state->m_stridesAllocIndex = PARNIANMINER_ALIGN(state->m_stridesAllocIndex + ss, 32);
        RH_ASSERT(state->m_stridesAllocIndex < RH2_STRIDE_BANK_SIZE);
        RH_ASSERT((size_t(state->m_stridesAllocIndex) % 32) == 0);
...
inline void SetLastDWordLE(RH_StridePtr in_stride, U32 newNonce)
{
    ...
    *(RH_STRIDE_GET_DATA(in_stride) + ((size - 4)/4)) = newNonce;
...
#if defined(RH2_ENABLE_MERSSEN_INTERLEAVE) && !defined(PARNIANMINER_NO_SSE4)
    ...
    {    
        ...
        RH_ASSERT(RH_STRIDE_GET_SIZE(state->m_roundInput) <= state->m_parnianHeaderSize);
    ...
    void RandomHash_Init(RandomHash_State* allStates, U32 startNonce)
    {
        ...
        RH_ASSERT(state->m_parnianHeaderSize > 0);
        ...
        if (state->m_isNewHeader)
        {
            ...
            RH_STRIDE_SET_SIZE(state->m_roundInput, state->m_parnianHeaderSize);
            memcpy(RH_STRIDE_GET_DATA(state->m_roundInput), &state->m_header[0], state->m_parnianHeaderSize); 
